      ...
      <div className="bg-gradient-to-r from-orange-600 to-orange-500">
        <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-5 max-w-xl mx-auto text-xl text-orange-100">
            ...
            <div>
              ...
              <div className="mt-6 space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="mt-1 text-gray-500">
                      123 Snack Street, Ahmedabad, Gujarat 380015
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="mt-1 text-gray-500">+91 79 2222 3333</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="mt-1 text-gray-500">info@jigkrupafarsan.com</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-8">
                ...
                <dl className="mt-2 space-y-2">
                  <div className="flex">
                    <dt className="w-32 text-gray-500">Monday - Friday</dt>
                    <dd className="text-gray-900">9:00 AM - 6:00 PM</dd>
                  </div>
                  <div className="flex">
                    <dt className="w-32 text-gray-500">Saturday</dt>
                    <dd className="text-gray-900">10:00 AM - 4:00 PM</dd>
                  </div>
                  <div className="flex">
                    <dt className="w-32 text-gray-500">Sunday</dt>
